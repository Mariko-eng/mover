                        ...
                        child: widget.trip.tripType.toLowerCase() == "ordinary"
                            ? Row(
                                ...
                                children: [
                                  ...
                                  widget.trip.discountPriceOrdinary > 0 ? Container() :
                                  Text(
                                    ...
                                    style: Theme.of(context)
                                        ...
                                        .copyWith(
                                            fontSize:
                                            widget.trip.discountPriceOrdinary != 0 ? 15 :
                                            18,
                                        color:
                                        widget.trip.discountPriceOrdinary != 0 ? Colors.black :Colors.white),
                                  ),
                                ],
                              )
                            : Column(
                                ...
                                children: [
                                  Padding(
                                    padding: const EdgeInsets.symmetric(
                                        horizontal: 10),
                                    child: widget.trip.discountPriceOrdinary ==
                                            0
                                        ? Row(
                                            mainAxisAlignment:
                                  ...
                                  Padding(
                                    padding: const EdgeInsets.symmetric(
                                        horizontal: 10),
                                    child: widget.trip.discountPriceVip == 0
                                        ? Row(
                                            mainAxisAlignment:
                                                MainAxisAlignment.spaceBetween,
                                            children: [
